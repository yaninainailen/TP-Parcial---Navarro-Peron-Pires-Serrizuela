...
**Versión de `system_prompt.md` usada como punto de partida:** la original —el `system_prompt.md` tal como quedó en la Entrega 2 de la materia, sin ninguna de las mejoras de este trabajo. Las tres iteraciones de abajo describen exactamente qué se le agregó.

> **Método:** esta corrida es parte del registro de desarrollo, ejecutada a mano y citada por fragmentos. La evidencia de ejecución completa de este caso vía API está en [`raw/solicitud_001_acme_claude-sonnet-5_20260901T115654.md`](raw/solicitud_001_acme_claude-sonnet-5_20260901T115654.md) (2026-09-01, contrato ya con todas las mejoras aplicadas). Ver [`README.md`](README.md) de esta carpeta.
